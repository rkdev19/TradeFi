...
/**
 * The argument types for the TenderFi contract
 */
export type TenderFiArgs = {
  /**
...
/**
 * Defines the types of available calls and state of the TenderFi smart contract.
 */
export type TenderFiTypes = {
  /**
   * Maps method signatures / names to their argument and return types.
   */
  methods:
    & Record<'create_application(asset,uint64)void' | 'create_application', {
      argsObj: TenderFiArgs['obj']['create_application(asset,uint64)void']
      argsTuple: TenderFiArgs['tuple']['create_application(asset,uint64)void']
      returns: TenderFiReturns['create_application(asset,uint64)void']
    }>
    & Record<'set_floor_price(uint64)void' | 'set_floor_price', {
      argsObj: TenderFiArgs['obj']['set_floor_price(uint64)void']
      argsTuple: TenderFiArgs['tuple']['set_floor_price(uint64)void']
      returns: TenderFiReturns['set_floor_price(uint64)void']
    }>
    & Record<'opt_in_to_asset(pay)void' | 'opt_in_to_asset', {
      argsObj: TenderFiArgs['obj']['opt_in_to_asset(pay)void']
      argsTuple: TenderFiArgs['tuple']['opt_in_to_asset(pay)void']
      returns: TenderFiReturns['opt_in_to_asset(pay)void']
    }>
    & Record<'place_bid(pay)void' | 'place_bid', {
      argsObj: TenderFiArgs['obj']['place_bid(pay)void']
      argsTuple: TenderFiArgs['tuple']['place_bid(pay)void']
      returns: TenderFiReturns['place_bid(pay)void']
    }>
    & Record<'accept_bid()void' | 'accept_bid', {
      argsObj: TenderFiArgs['obj']['accept_bid()void']
      argsTuple: TenderFiArgs['tuple']['accept_bid()void']
      returns: TenderFiReturns['accept_bid()void']
    }>
    & Record<'reject_bid()void' | 'reject_bid', {
      argsObj: TenderFiArgs['obj']['reject_bid()void']
      argsTuple: TenderFiArgs['tuple']['reject_bid()void']
      returns: TenderFiReturns['reject_bid()void']
    }>
    & Record<'delete_application()void' | 'delete_application', {
      argsObj: TenderFiArgs['obj']['delete_application()void']
      argsTuple: TenderFiArgs['tuple']['delete_application()void']
      returns: TenderFiReturns['delete_application()void']
    }>
  /**
 ...
 */
export type TenderFiSignatures = keyof TenderFiTypes['methods']
/**
 * Defines the possible abi call signatures for methods that return a non-void value.
 */
export type TenderFiNonVoidMethodSignatures = keyof TenderFiTypes['methods'] extends infer T ? T extends keyof TenderFiTypes['methods'] ? MethodReturn<T> extends void ? never : T  : never : never
/**
...
>
/**
 * Maps a method signature from the TenderFi smart contract to the method's arguments in either tuple or struct form
 */
export type MethodArgs<TSignature extends TenderFiSignatures> = TenderFiTypes['methods'][TSignature]['argsObj' | 'argsTuple']
/**
 * Maps a method signature from the TenderFi smart contract to the method's return type
 */
export type MethodReturn<TSignature extends TenderFiSignatures> = TenderFiTypes['methods'][TSignature]['returns']

/**
 * Defines the shape of the keyed global state of the application.
 */
export type GlobalKeysState = TenderFiTypes['state']['global']['keys']


/**
 * Defines supported create method params for this smart contract
 */
export type TenderFiCreateCallParams =
  | Expand<CallParams<TenderFiArgs['obj']['create_application(asset,uint64)void'] | TenderFiArgs['tuple']['create_application(asset,uint64)void']> & {method: 'create_application'} & {onComplete?: OnApplicationComplete.NoOpOC} & CreateSchema>
  | Expand<CallParams<TenderFiArgs['obj']['create_application(asset,uint64)void'] | TenderFiArgs['tuple']['create_application(asset,uint64)void']> & {method: 'create_application(asset,uint64)void'} & {onComplete?: OnApplicationComplete.NoOpOC} & CreateSchema>
/**
 * Defines supported delete method params for this smart contract
 */
export type TenderFiDeleteCallParams =
  | Expand<CallParams<TenderFiArgs['obj']['delete_application()void'] | TenderFiArgs['tuple']['delete_application()void']> & {method: 'delete_application'}>
  | Expand<CallParams<TenderFiArgs['obj']['delete_application()void'] | TenderFiArgs['tuple']['delete_application()void']> & {method: 'delete_application()void'}>
/**
 * Defines arguments required for the deploy method.
 */
export type TenderFiDeployParams = Expand<Omit<AppFactoryDeployParams, 'createParams' | 'updateParams' | 'deleteParams'> & {
  /**
   * Create transaction parameters to use if a create needs to be issued as part of deployment; use `method` to define ABI call (if available) or leave out for a bare call (if available)
   */
  createParams?: TenderFiCreateCallParams
  /**
   * Delete transaction parameters to use if a create needs to be issued as part of deployment; use `method` to define ABI call (if available) or leave out for a bare call (if available)
   */
  deleteParams?: TenderFiDeleteCallParams
}>


/**
 * Exposes methods for constructing `AppClient` params objects for ABI calls to the TenderFi smart contract
 */
export abstract class TenderFiParamsFactory {
  /**
   * Gets available create ABI call param factories
   */
  static get create() {
    return {
      _resolveByMethod<TParams extends TenderFiCreateCallParams & {method: string}>(params: TParams) {
        switch(params.method) {
          case 'create_application':
          case 'create_application(asset,uint64)void':
            return TenderFiParamsFactory.create.createApplication(params)
        }
        throw new Error(`Unknown ' + verb + ' method`)
      },

      /**
       * Constructs create ABI call params for the TenderFi smart contract using the create_application(asset,uint64)void ABI method
       *
       * @param params Parameters for the call
       * @returns An `AppClientMethodCallParams` object for the call
       */
      createApplication(params: CallParams<TenderFiArgs['obj']['create_application(asset,uint64)void'] | TenderFiArgs['tuple']['create_application(asset,uint64)void']> & AppClientCompilationParams & {onComplete?: OnApplicationComplete.NoOpOC}): AppClientMethodCallParams & AppClientCompilationParams & {onComplete?: OnApplicationComplete.NoOpOC} {
        return {
          ...params,
  ...
  static get delete() {
    return {
      _resolveByMethod<TParams extends TenderFiDeleteCallParams & {method: string}>(params: TParams) {
        switch(params.method) {
          case 'delete_application':
          case 'delete_application()void':
            return TenderFiParamsFactory.delete.deleteApplication(params)
        }
        throw new Error(`Unknown ' + verb + ' method`)
      },

      /**
       * Constructs delete ABI call params for the TenderFi smart contract using the delete_application()void ABI method
       *
       * @param params Parameters for the call
       * @returns An `AppClientMethodCallParams` object for the call
       */
      deleteApplication(params: CallParams<TenderFiArgs['obj']['delete_application()void'] | TenderFiArgs['tuple']['delete_application()void']>): AppClientMethodCallParams {
        return {
          ...params,
   ...
   * @returns An `AppClientMethodCallParams` object for the call
   */
  static setFloorPrice(params: CallParams<TenderFiArgs['obj']['set_floor_price(uint64)void'] | TenderFiArgs['tuple']['set_floor_price(uint64)void']> & CallOnComplete): AppClientMethodCallParams & CallOnComplete {
    return {
      ...params,
   ...
   * @returns An `AppClientMethodCallParams` object for the call
   */
  static optInToAsset(params: CallParams<TenderFiArgs['obj']['opt_in_to_asset(pay)void'] | TenderFiArgs['tuple']['opt_in_to_asset(pay)void']> & CallOnComplete): AppClientMethodCallParams & CallOnComplete {
    return {
      ...params,
   ...
   * @returns An `AppClientMethodCallParams` object for the call
   */
  static placeBid(params: CallParams<TenderFiArgs['obj']['place_bid(pay)void'] | TenderFiArgs['tuple']['place_bid(pay)void']> & CallOnComplete): AppClientMethodCallParams & CallOnComplete {
    return {
      ...params,
   ...
   * @returns An `AppClientMethodCallParams` object for the call
   */
  static acceptBid(params: CallParams<TenderFiArgs['obj']['accept_bid()void'] | TenderFiArgs['tuple']['accept_bid()void']> & CallOnComplete): AppClientMethodCallParams & CallOnComplete {
    return {
      ...params,
   ...
   * @returns An `AppClientMethodCallParams` object for the call
   */
  static rejectBid(params: CallParams<TenderFiArgs['obj']['reject_bid()void'] | TenderFiArgs['tuple']['reject_bid()void']> & CallOnComplete): AppClientMethodCallParams & CallOnComplete {
    return {
      ...params,
...
/**
 * A factory to create and deploy one or more instance of the TenderFi smart contract and to create one or more app clients to interact with those (or other) app instances
 */
export class TenderFiFactory {
  /**
  ...
  /**
   * Creates a new instance of `TenderFiFactory`
   *
  ...
  public getAppClientById(params: AppFactoryAppClientParams) {
    return new TenderFiClient(this.appFactory.getAppClientById(params))
  }
  ...
  public async getAppClientByCreatorAndName(
    ...
    return new TenderFiClient(await this.appFactory.getAppClientByCreatorAndName(params))
  }

  /**
   * Idempotently deploys the TenderFi smart contract.
   *
   * @param params The arguments for the contract calls and any additional parameters for the call
   * @returns The deployment result
   */
  public async deploy(params: TenderFiDeployParams = {}) {
    const result = await this.appFactory.deploy({
      ...params,
      createParams: params.createParams?.method ? TenderFiParamsFactory.create._resolveByMethod(params.createParams) : params.createParams ? params.createParams as (TenderFiCreateCallParams & { args: Uint8Array[] }) : undefined,
      deleteParams: params.deleteParams?.method ? TenderFiParamsFactory.delete._resolveByMethod(params.deleteParams) : params.deleteParams ? params.deleteParams as (TenderFiDeleteCallParams & { args: Uint8Array[] }) : undefined,
    })
    return { result: result.result, appClient: new TenderFiClient(result.appClient) }
  }
  ...
  readonly params = {
    ...
    create: {
      /**
       * Creates a new instance of the TenderFi smart contract using the create_application(asset,uint64)void ABI method.
       *
       * @param params The params for the smart contract call
       * @returns The create params
       */
      createApplication: (params: CallParams<TenderFiArgs['obj']['create_application(asset,uint64)void'] | TenderFiArgs['tuple']['create_application(asset,uint64)void']> & AppClientCompilationParams & CreateSchema & {onComplete?: OnApplicationComplete.NoOpOC}) => {
        return this.appFactory.params.create(TenderFiParamsFactory.create.createApplication(params))
      },
    },
    ...
    deployDelete: {
      /**
       * Deletes an existing instance of the TenderFi smart contract using the delete_application()void ABI method.
       *
       * @param params The params for the smart contract call
       * @returns The deployDelete params
       */
      deleteApplication: (params: CallParams<TenderFiArgs['obj']['delete_application()void'] | TenderFiArgs['tuple']['delete_application()void']> = {args: []}) => {
        return this.appFactory.params.deployDelete(TenderFiParamsFactory.delete.deleteApplication(params))
      },
    },
  ...
  readonly createTransaction = {
    ...
    create: {
       ...
       */
      createApplication: (params: CallParams<TenderFiArgs['obj']['create_application(asset,uint64)void'] | TenderFiArgs['tuple']['create_application(asset,uint64)void']> & AppClientCompilationParams & CreateSchema & {onComplete?: OnApplicationComplete.NoOpOC}) => {
        return this.appFactory.createTransaction.create(TenderFiParamsFactory.create.createApplication(params))
      },
    },
  ...
  readonly send = {
    ...
    create: {
      /**
       * Creates a new instance of the TenderFi smart contract using an ABI method call using the create_application(asset,uint64)void ABI method.
       *
       * @param params The params for the smart contract call
       * @returns The create result
       */
      createApplication: async (params: CallParams<TenderFiArgs['obj']['create_application(asset,uint64)void'] | TenderFiArgs['tuple']['create_application(asset,uint64)void']> & AppClientCompilationParams & CreateSchema & SendParams & {onComplete?: OnApplicationComplete.NoOpOC}) => {
        const result = await this.appFactory.send.create(TenderFiParamsFactory.create.createApplication(params))
        return { result: { ...result.result, return: result.result.return as unknown as (undefined | TenderFiReturns['create_application(asset,uint64)void']) }, appClient: new TenderFiClient(result.appClient) }
      },
    },
...
/**
 * A client to make calls to the TenderFi smart contract
 */
export class TenderFiClient {
  /**
  ...
  /**
   * Creates a new instance of `TenderFiClient`
   *
   * @param appClient An `AppClient` instance which has been created with the TenderFi app spec
   */
   ...
   */
  decodeReturnValue<TSignature extends TenderFiNonVoidMethodSignatures>(method: TSignature, returnValue: ABIReturn | undefined) {
    return returnValue !== undefined ? getArc56ReturnValue<MethodReturn<TSignature>>(returnValue, this.appClient.getABIMethod(method), APP_SPEC.structs) : undefined
  }
  
  /**
   * Returns a new `TenderFiClient` client, resolving the app by creator address and name
   * using AlgoKit app deployment semantics (i.e. looking for the app creation transaction note).
   * @param params The parameters to create the app client
   */
  public static async fromCreatorAndName(params: Omit<ResolveAppClientByCreatorAndName, 'appSpec'>): Promise<TenderFiClient> {
    return new TenderFiClient(await _AppClient.fromCreatorAndName({...params, appSpec: APP_SPEC}))
  }
  
  /**
   * Returns an `TenderFiClient` instance for the current network based on
  ...
  ): Promise<TenderFiClient> {
    return new TenderFiClient(await _AppClient.fromNetwork({...params, appSpec: APP_SPEC}))
  }
  ...
  readonly params = {
    ...
    delete: {
       ...
       */
      deleteApplication: (params: CallParams<TenderFiArgs['obj']['delete_application()void'] | TenderFiArgs['tuple']['delete_application()void']> = {args: []}) => {
        return this.appClient.params.delete(TenderFiParamsFactory.delete.deleteApplication(params))
      },

    },

    /**
     * Makes a clear_state call to an existing instance of the TenderFi smart contract.
     *
    ...
    /**
     * Makes a call to the TenderFi smart contract using the `set_floor_price(uint64)void` ABI method.
     *
     * @param params The params for the smart contract call
     * @returns The call params
     */
    setFloorPrice: (params: CallParams<TenderFiArgs['obj']['set_floor_price(uint64)void'] | TenderFiArgs['tuple']['set_floor_price(uint64)void']> & {onComplete?: OnApplicationComplete.NoOpOC}) => {
      return this.appClient.params.call(TenderFiParamsFactory.setFloorPrice(params))
    },

    /**
     * Makes a call to the TenderFi smart contract using the `opt_in_to_asset(pay)void` ABI method.
     *
     * @param params The params for the smart contract call
     * @returns The call params
     */
    optInToAsset: (params: CallParams<TenderFiArgs['obj']['opt_in_to_asset(pay)void'] | TenderFiArgs['tuple']['opt_in_to_asset(pay)void']> & {onComplete?: OnApplicationComplete.NoOpOC}) => {
      return this.appClient.params.call(TenderFiParamsFactory.optInToAsset(params))
    },

    /**
     * Makes a call to the TenderFi smart contract using the `place_bid(pay)void` ABI method.
     *
     * @param params The params for the smart contract call
     * @returns The call params
     */
    placeBid: (params: CallParams<TenderFiArgs['obj']['place_bid(pay)void'] | TenderFiArgs['tuple']['place_bid(pay)void']> & {onComplete?: OnApplicationComplete.NoOpOC}) => {
      return this.appClient.params.call(TenderFiParamsFactory.placeBid(params))
    },

    /**
     * Makes a call to the TenderFi smart contract using the `accept_bid()void` ABI method.
     *
     * @param params The params for the smart contract call
     * @returns The call params
     */
    acceptBid: (params: CallParams<TenderFiArgs['obj']['accept_bid()void'] | TenderFiArgs['tuple']['accept_bid()void']> & {onComplete?: OnApplicationComplete.NoOpOC} = {args: []}) => {
      return this.appClient.params.call(TenderFiParamsFactory.acceptBid(params))
    },

    /**
     * Makes a call to the TenderFi smart contract using the `reject_bid()void` ABI method.
     *
     * @param params The params for the smart contract call
     * @returns The call params
     */
    rejectBid: (params: CallParams<TenderFiArgs['obj']['reject_bid()void'] | TenderFiArgs['tuple']['reject_bid()void']> & {onComplete?: OnApplicationComplete.NoOpOC} = {args: []}) => {
      return this.appClient.params.call(TenderFiParamsFactory.rejectBid(params))
    },
  ...
  readonly createTransaction = {
    ...
    delete: {
       ...
       */
      deleteApplication: (params: CallParams<TenderFiArgs['obj']['delete_application()void'] | TenderFiArgs['tuple']['delete_application()void']> = {args: []}) => {
        return this.appClient.createTransaction.delete(TenderFiParamsFactory.delete.deleteApplication(params))
      },
     ...
     */
    setFloorPrice: (params: CallParams<TenderFiArgs['obj']['set_floor_price(uint64)void'] | TenderFiArgs['tuple']['set_floor_price(uint64)void']> & {onComplete?: OnApplicationComplete.NoOpOC}) => {
      return this.appClient.createTransaction.call(TenderFiParamsFactory.setFloorPrice(params))
    },
     ...
     */
    optInToAsset: (params: CallParams<TenderFiArgs['obj']['opt_in_to_asset(pay)void'] | TenderFiArgs['tuple']['opt_in_to_asset(pay)void']> & {onComplete?: OnApplicationComplete.NoOpOC}) => {
      return this.appClient.createTransaction.call(TenderFiParamsFactory.optInToAsset(params))
    },
     ...
     */
    placeBid: (params: CallParams<TenderFiArgs['obj']['place_bid(pay)void'] | TenderFiArgs['tuple']['place_bid(pay)void']> & {onComplete?: OnApplicationComplete.NoOpOC}) => {
      return this.appClient.createTransaction.call(TenderFiParamsFactory.placeBid(params))
    },
     ...
     */
    acceptBid: (params: CallParams<TenderFiArgs['obj']['accept_bid()void'] | TenderFiArgs['tuple']['accept_bid()void']> & {onComplete?: OnApplicationComplete.NoOpOC} = {args: []}) => {
      return this.appClient.createTransaction.call(TenderFiParamsFactory.acceptBid(params))
    },
     ...
     */
    rejectBid: (params: CallParams<TenderFiArgs['obj']['reject_bid()void'] | TenderFiArgs['tuple']['reject_bid()void']> & {onComplete?: OnApplicationComplete.NoOpOC} = {args: []}) => {
      return this.appClient.createTransaction.call(TenderFiParamsFactory.rejectBid(params))
    },
  ...
  readonly send = {
    ...
    delete: {
       ...
       */
      deleteApplication: async (params: CallParams<TenderFiArgs['obj']['delete_application()void'] | TenderFiArgs['tuple']['delete_application()void']> & SendParams = {args: []}) => {
        const result = await this.appClient.send.delete(TenderFiParamsFactory.delete.deleteApplication(params))
        return {...result, return: result.return as unknown as (undefined | TenderFiReturns['delete_application()void'])}
      },
     ...
     */
    setFloorPrice: async (params: CallParams<TenderFiArgs['obj']['set_floor_price(uint64)void'] | TenderFiArgs['tuple']['set_floor_price(uint64)void']> & SendParams & {onComplete?: OnApplicationComplete.NoOpOC}) => {
      const result = await this.appClient.send.call(TenderFiParamsFactory.setFloorPrice(params))
      return {...result, return: result.return as unknown as (undefined | TenderFiReturns['set_floor_price(uint64)void'])}
    },
     ...
     * @returns The call result
     */
    optInToAsset: async (params: CallParams<TenderFiArgs['obj']['opt_in_to_asset(pay)void'] | TenderFiArgs['tuple']['opt_in_to_asset(pay)void']> & SendParams & {onComplete?: OnApplicationComplete.NoOpOC}) => {
      const result = await this.appClient.send.call(TenderFiParamsFactory.optInToAsset(params))
      return {...result, return: result.return as unknown as (undefined | TenderFiReturns['opt_in_to_asset(pay)void'])}
    },
     ...
     * @returns The call result
     */
    placeBid: async (params: CallParams<TenderFiArgs['obj']['place_bid(pay)void'] | TenderFiArgs['tuple']['place_bid(pay)void']> & SendParams & {onComplete?: OnApplicationComplete.NoOpOC}) => {
      const result = await this.appClient.send.call(TenderFiParamsFactory.placeBid(params))
      return {...result, return: result.return as unknown as (undefined | TenderFiReturns['place_bid(pay)void'])}
    },
     ...
     * @returns The call result
     */
    acceptBid: async (params: CallParams<TenderFiArgs['obj']['accept_bid()void'] | TenderFiArgs['tuple']['accept_bid()void']> & SendParams & {onComplete?: OnApplicationComplete.NoOpOC} = {args: []}) => {
      const result = await this.appClient.send.call(TenderFiParamsFactory.acceptBid(params))
      return {...result, return: result.return as unknown as (undefined | TenderFiReturns['accept_bid()void'])}
    },
     ...
     * @returns The call result
     */
    rejectBid: async (params: CallParams<TenderFiArgs['obj']['reject_bid()void'] | TenderFiArgs['tuple']['reject_bid()void']> & SendParams & {onComplete?: OnApplicationComplete.NoOpOC} = {args: []}) => {
      const result = await this.appClient.send.call(TenderFiParamsFactory.rejectBid(params))
      return {...result, return: result.return as unknown as (undefined | TenderFiReturns['reject_bid()void'])}
    },
  ...
  public clone(params: CloneAppClientParams) {
    return new TenderFiClient(this.appClient.clone(params))
  }

  /**
   * Methods to access state for the current TenderFi app
   */
  state = {
    /**
     * Methods to access global state for the current TenderFi app
     */
    global: {
      /**
  ...
  public newGroup(): TenderFiComposer {
    const client = this
    ...
    return {
      /**
       * Add a set_floor_price(uint64)void method call against the TenderFi contract
       */
      setFloorPrice(params: CallParams<TenderFiArgs['obj']['set_floor_price(uint64)void'] | TenderFiArgs['tuple']['set_floor_price(uint64)void']> & {onComplete?: OnApplicationComplete.NoOpOC}) {
      ...
      /**
       * Add a opt_in_to_asset(pay)void method call against the TenderFi contract
       */
      optInToAsset(params: CallParams<TenderFiArgs['obj']['opt_in_to_asset(pay)void'] | TenderFiArgs['tuple']['opt_in_to_asset(pay)void']> & {onComplete?: OnApplicationComplete.NoOpOC}) {
      ...
      /**
       * Add a place_bid(pay)void method call against the TenderFi contract
       */
      placeBid(params: CallParams<TenderFiArgs['obj']['place_bid(pay)void'] | TenderFiArgs['tuple']['place_bid(pay)void']> & {onComplete?: OnApplicationComplete.NoOpOC}) {
      ...
      /**
       * Add a accept_bid()void method call against the TenderFi contract
       */
      acceptBid(params: CallParams<TenderFiArgs['obj']['accept_bid()void'] | TenderFiArgs['tuple']['accept_bid()void']> & {onComplete?: OnApplicationComplete.NoOpOC}) {
        promiseChain = promiseChain.then(async () => composer.addAppCallMethodCall(await client.params.acceptBid(params)))
        resultMappers.push(undefined)
        return this
      },
      /**
       * Add a reject_bid()void method call against the TenderFi contract
       */
      rejectBid(params: CallParams<TenderFiArgs['obj']['reject_bid()void'] | TenderFiArgs['tuple']['reject_bid()void']> & {onComplete?: OnApplicationComplete.NoOpOC}) {
      ...
      get delete() {
        return {
          deleteApplication: (params: CallParams<TenderFiArgs['obj']['delete_application()void'] | TenderFiArgs['tuple']['delete_application()void']>) => {
      ...
      /**
       * Add a clear state call to the TenderFi contract
       */
    ...
    } as unknown as TenderFiComposer
  }
}
export type TenderFiComposer<TReturns extends [...any[]] = []> = {
  /**
   ...
   */
  setFloorPrice(params?: CallParams<TenderFiArgs['obj']['set_floor_price(uint64)void'] | TenderFiArgs['tuple']['set_floor_price(uint64)void']>): TenderFiComposer<[...TReturns, TenderFiReturns['set_floor_price(uint64)void'] | undefined]>
   ...
   * @returns The typed transaction composer so you can fluently chain multiple calls or call execute to execute all queued up transactions
   */
  optInToAsset(params?: CallParams<TenderFiArgs['obj']['opt_in_to_asset(pay)void'] | TenderFiArgs['tuple']['opt_in_to_asset(pay)void']>): TenderFiComposer<[...TReturns, TenderFiReturns['opt_in_to_asset(pay)void'] | undefined]>
   ...
   * @returns The typed transaction composer so you can fluently chain multiple calls or call execute to execute all queued up transactions
   */
  placeBid(params?: CallParams<TenderFiArgs['obj']['place_bid(pay)void'] | TenderFiArgs['tuple']['place_bid(pay)void']>): TenderFiComposer<[...TReturns, TenderFiReturns['place_bid(pay)void'] | undefined]>
   ...
   * @returns The typed transaction composer so you can fluently chain multiple calls or call execute to execute all queued up transactions
   */
  acceptBid(params?: CallParams<TenderFiArgs['obj']['accept_bid()void'] | TenderFiArgs['tuple']['accept_bid()void']>): TenderFiComposer<[...TReturns, TenderFiReturns['accept_bid()void'] | undefined]>
   ...
   * @returns The typed transaction composer so you can fluently chain multiple calls or call execute to execute all queued up transactions
   */
  rejectBid(params?: CallParams<TenderFiArgs['obj']['reject_bid()void'] | TenderFiArgs['tuple']['reject_bid()void']>): TenderFiComposer<[...TReturns, TenderFiReturns['reject_bid()void'] | undefined]>
  ...
  readonly delete: {
     ...
     * @returns The typed transaction composer so you can fluently chain multiple calls or call execute to execute all queued up transactions
     */
    deleteApplication(params?: CallParams<TenderFiArgs['obj']['delete_application()void'] | TenderFiArgs['tuple']['delete_application()void']>): TenderFiComposer<[...TReturns, TenderFiReturns['delete_application()void'] | undefined]>
  }
   ...
   * @returns The typed transaction composer so you can fluently chain multiple calls or call execute to execute all queued up transactions
   */
  clearState(params?: AppClientBareCallParams): TenderFiComposer<[...TReturns, undefined]>
   ...
   */
  addTransaction(txn: Transaction, signer?: TransactionSigner): TenderFiComposer<TReturns>
  /**
   ...
   */
  simulate(): Promise<TenderFiComposerResults<TReturns> & { simulateResponse: SimulateResponse }>
  simulate(options: SkipSignaturesSimulateOptions): Promise<TenderFiComposerResults<TReturns> & { simulateResponse: SimulateResponse }>
  simulate(options: RawSimulateOptions): Promise<TenderFiComposerResults<TReturns> & { simulateResponse: SimulateResponse }>
  /**
   * Sends the transaction group to the network and returns the results
   */
  send(params?: SendParams): Promise<TenderFiComposerResults<TReturns>>
}
export type TenderFiComposerResults<TReturns extends [...any[]]> = Expand<SendAtomicTransactionComposerResults & {
  returns: TReturns
}>
